...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Oleg Bogdanov",
            "email": "tagwaylander223@gmail.com"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/subscription.ListResult"
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/subscription.SubscriptionReq"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/subscription.SubscriptionResp"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/subscription.TotalCostResp"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        "subscription.ErrorResponse": {
            ...
            "properties": {
                "error": {
                    "type": "string",
                    "example": "invalid date format, use MM-YYYY"
                }
            }
        },
        "subscription.ListResult": {
            "type": "object",
            "properties": {
                "has_more": {
                    "type": "boolean",
